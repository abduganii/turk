      ...
      <Contianer className={"mt-[-250px] md:mt-[-100px]"}>
        <div className="flex flex-wrap  md:flex-nowrap justify-between gap-[10px] items-center pb-[40px]">
          <div className="w-full max-w-[350px]  tablet:max-w-[500px] xl:max-w-[690px]">
            <h2 class="text-white font-extrabold text-[70px] tablet:text-[100px] xl:text-[140px]">ISTANBUL</h2>
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-[10px] ">
          <div class="w-full max-w-[650px] pl-[29px] md:pl-[65px] px-[65px] md:pt-[62px] pt-[38px] md:pb-[103px] pb-[204px] mt-[53px] bg-white">
            <h4 class="w-full max-w-[496px] text-neutral-800 text-[32px] sm:text-[44px] font-semibold pb-[17px]">
              О жилой комплексе
            </h4>
            <p class="w-full max-w-[496px] text-neutral-800 text-base  sm:text-lg font-normal  leading-[27px]">
          ...
          <div className="w-full max-w-[600px] h-[400px] md:h-[700px] relative mt-[-150px] px-[20px] md:px-[0] md:mt-[0]">
            ...
            />
            <Image
              className="w-[186px] md:w-[360px] absolute left-[60px] md:left-[99px] top-[70px] md:top-[130px]  object-cover h-[266px] md:h-[515px]"
              src="/logoa.png"
              width={360}
              height={515}
            />
